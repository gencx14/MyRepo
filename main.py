...
system.add_conductor("partridge", 0.642, 0.0217, 0.385, 2, 1.5)
...
system.add_transmissionLineData("L2", "bus2", "bus3", system.transmissionlineDataItems["mainLine"], 25)
system.add_transmissionLineData("L3", "bus3", "bus5", system.transmissionlineDataItems["mainLine"], 20)
system.add_transmissionLineData("L4", "bus4", "bus6", system.transmissionlineDataItems["mainLine"], 20)
system.add_transmissionLineData("L5", "bus5", "bus6", system.transmissionlineDataItems["mainLine"], 10)
system.add_transmissionLineData("L6", "bus4", "bus5", system.transmissionlineDataItems["mainLine"], 35)
